...
if($id=="")
	$sql = "insert into mtrs_cp_product(name,cpId,mourl,mrurl,checkblk,remarks,createtime) values('$name','$cpID','$mourl','$mrurl',$checkblk,'$remarks','$createtime')";
else
	$sql="update mtrs_cp_product set name='$name',cpID='$cpID',mourl='$mourl',mrurl='$mrurl',checkblk='$checkblk',remarks='$remarks',createtime='$createtime' where id=$id";
echo $sql;
