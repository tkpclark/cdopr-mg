...
?>
	...
	<tr>
		<td colspan=4>
			...
			<input type='checkbox' id="spID_group" name='spID_group' value="on">通道分组&nbsp;&nbsp;&nbsp;
			<input type='checkbox' id="serviceID_group" name='serviceID_group' value="on">通道业务分组&nbsp;&nbsp;&nbsp;
			<input type='checkbox' id="cpID_group" name='cpID_group' value="on">渠道分组&nbsp;&nbsp;&nbsp;
			<input type='checkbox' id="cpProdID_group" name='cpProdID_group' value="on">渠道业务分组&nbsp;&nbsp;&nbsp;
			<input type='checkbox' id="is_agent_group" name='is_agent_group' value="on">代计费业务分组&nbsp;&nbsp;&nbsp;
			<input type='checkbox' id="feetype_group" name='feetype_group' value="on">计费类型分组&nbsp;&nbsp;&nbsp;
			<input type='checkbox' id="gwid_group" name='gwid_group' value="on">网关分组&nbsp;&nbsp;&nbsp;
			<input type='checkbox' id="province_group" name='province_group' value="on">省分组&nbsp;&nbsp;&nbsp;
			<input type='checkbox' id="cmdID_group" name='cmdID_group' value="on">指令分组&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
