...
<?php 
   ...
   //////////////
	 	...
	 	$sql="select * from $tbl where payment_user like '%$pn%' order by ID desc limit $start_item,$pg_lmt";
  ...
  while($row=mysqli_fetch_row($result))
  {
		...
		echo "<td>".$row[2]."</td>";
  		echo "<td align=center  onclick=\"return ask($row[0]);\"><font size=2><a href=\"wo_blklist_del.php?id=$row[0]\" ><img src='images/b_drop.png' alt='删除'></a>&nbsp;</td>";
  		echo "</tr>";
  }
