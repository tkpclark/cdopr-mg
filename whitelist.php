...
<?php 
	...
	$pn=isset($_POST['pn'])?$_POST['pn']:isset($_GET['pn'])?$_GET['pn']:"";  //inquiry this month
 	...
 	$page_title="白名单";
	$page_name="whitelist.php";
	$pg_lmt=20;
	$tbl="wraith_whitelist";
  ...
  while($row=mysqli_fetch_row($result))
  {
  		...
  		echo "<td align=center  onclick=\"return ask($row[0]);\"><font size=2><a href=\"whitelist_del.php?id=$row[0]\" ><img src='images/b_drop.png' alt='删除'></a>&nbsp;</td>";
  		echo "</tr>";
  }
