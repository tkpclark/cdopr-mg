...
<?php
	...
	{	
		...
		$sql_condition.="and phone='".$_REQUEST["phone_number"]."' ";
	}
	...
	{	
		...
		$sql="select id,motime,phone,mo_message,sp_number,gwid,mo_status,fee,feetype,mt_message,service_id,msgtype,is_agent,report,province,area,spID,spname,serviceID,service_name,cpID,cpname,cp_productID,cp_product_name,cmdID,complaint_time from $tb ";
		$sql.=$sql_condition;
		/*
		$sql.=" union all ";
		...
		*/
		...
		{	
			...
			while($row=mysqli_fetch_assoc($result))
			{
				...
				echo "<td>".substr($row['phone'],0,11)."</td>";
